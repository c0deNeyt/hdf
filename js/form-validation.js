  ...
  Array.prototype.slice.call(forms)
    .forEach(function (form) {
      form.addEventListener('submit', function (event) {
        ...
        function emails() {
          this.withSympAndHighBTemp = function(){
            // console.log("Employee have a higher body Temperature and Symptoms!");
            // ** EMAIL API FORMAT THAT Employee have a higher body temperature
          ...
          this.withHighBTemp = function(){
            // console.log("Employee have a higher body Temperature!");
            // ** Email API format that employee have a higher body temperature!
            Email.send({
              Host: "smtp.gmail.com",
              Username : "telford.mis.hdf.developer@gmail.com",
          ...
          this.withSymptoms = function(){
            // console.log("Employee have a COVID19 SYMPTOMS!");
          ...
          this.covid19SymptomsDetected = function (str){
            Swal.fire({
              ...
              result.dismiss === Swal.DismissReason.cancel
                ...
                Swal.fire({
                  title: 'Cancelled',
                  text: "Data unsaved and not sent ! :(",
                  icon: 'error',
                  backdrop: "rgba(209, 10, 10, 0.77)",
                  confirmButtonColor: '#22BB33',
                });
